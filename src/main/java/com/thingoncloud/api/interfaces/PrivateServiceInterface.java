...
public interface PrivateServiceInterface {
	WebUserResponse activate(BeanWebUser webUser);
	WebUserResponse passwordUpdate(BeanWebUser webUser);
	WebUserResponse passwordReset(BeanWebUser webUser);
	WebUserResponse validateEmail(BeanWebUser webUser); 	
	WebUserCredentialsResponse register(BeanWebUser webUser);
	WebUserCredentialsResponse authenticate(BeanWebUser webUser);
}
