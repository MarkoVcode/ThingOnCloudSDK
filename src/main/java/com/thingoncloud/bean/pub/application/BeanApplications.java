...
public class BeanApplications implements Serializable {
	...
	private static final long serialVersionUID = -2535796038123078480L;
	
	private Ref self;
	private Ref owner;
	private Ref parent;
	private List<BeanApplication> applications;
	...
	public List<BeanApplication> getApplications() {
		return applications;
	}
	public void setApplications(List<BeanApplication> applications) {
	...
	public String toString() {
		...
		for(BeanApplication app : applications) {
